...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath: '/assets/plugins/editor/nicEditorIcons.gif',
    buttonList: ['xhtml', 'save', 'bold', 'italic', 'underline', 'left', 'center', 'right', 'justify', 'ol', 'ul', 'fontSize', 'fontFormat', 'indent', 'outdent', 'image', 'upload', 'link', 'unlink', 'forecolor', 'bgcolor'],
    iconList: {
        "xhtml": 1,
        "bgcolor": 2,
        "forecolor": 3,
...
var nicEditorInstance = bkClass.extend({
    ...
    init: function () {
        this.elm.setAttribute('id', 'nicEditContent');
...
var nicUploadButton = nicEditorAdvancedButton.extend({
    nicURI: '/assets/plugins/editor/upload.php',
