...
/**
 * NumberForPhoneAssignment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NumberForPhoneAssignment implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'NumberForPhoneAssignment';
     ...
     *
     * @param int $phone_number_id the Id of the PhoneNumber that is assigned
     *
     * @return $this
     */
     ...
     * Sets phone_number
     *
     * @param string $phone_number The number of the PhoneNumber
     *
     * @return $this
     */
     ...
     * Sets active
     *
     * @param bool $active the flag that indicates whether the PhoneNumber is active for this assignment.
     *
     * @return $this
     */
