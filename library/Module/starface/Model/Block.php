 ...
 *
 * @category Class
 * @description Blocks contain a list of attributes for a contact
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Block implements ModelInterface, ArrayAccess
{
     ...
     * Sets resource_key
     *
     * @param string $resource_key The resourceKey of the block
     *
     * @return $this
     */
     ...
     * Sets attributes
     *
     * @param \Swagger\Client\Model\Attribute[] $attributes A List of attributes
     *
     * @return $this
     */
