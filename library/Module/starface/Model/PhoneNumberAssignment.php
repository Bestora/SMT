...
/**
 * PhoneNumberAssignment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PhoneNumberAssignment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PhoneNumberAssignment';
     ...
     *
     * @param int $phone_number_id the Id of the PhoneNumber that is assigned to the User
     *
     * @return $this
     */
     ...
     * Sets number
     *
     * @param string $number the number of the PhoneNumber that is assigned to the User
     *
     * @return $this
     */
     ...
     * Sets exit_code
     *
     * @param string $exit_code the exit code of the PhoneNumber that is assigned to the User
     *
     * @return $this
     */
     ...
     * Sets local_prefix
     *
     * @param string $local_prefix the local prefix of the PhoneNumber that is assigned to the User
     *
     * @return $this
     */
     ...
     *
     * @param string $national_prefix the national prefix of the PhoneNumber that is assigned to the User
     *
     * @return $this
     */
     ...
     * Sets service_id
     *
     * @param int $service_id the Id of the call service rule that is used for this phone number.
     *
     * @return $this
     */
