 ...
 *
 * @category Class
 * @description Summary values from contacts without schema information. For information on what fields these values
 *   correspond get the ContactsScheme.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactSummary implements ModelInterface, ArrayAccess
{
   ...
   *
   * @param map[string,string] $additional_values Additional values for the ContactSummary, for example
   *   INTERNAL_NUMBER, EXTERNAL_NUMBER, AVATAR, USER_ACCOUNT_ID
   *
   * @return $this
   */
