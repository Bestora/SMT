 ...
 *
 * @category Class
 * @description Metadata for a request that returns data for multiple entities. This includes pageing and sorting
 *   properties.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
...
class RequestMetadata implements ModelInterface, ArrayAccess
{
   ...
   * Sets pagesize
   *
   * @param int $pagesize The pagesize used for the request. Indicates the row count of data that has just been
   *   returned.
   *
   * @return $this
   */
   ...
   * Sets sortdirection
   *
   * @param string $sortdirection The sort direction that has been used. Either ASC for ascending or DESC for
   *   descending.
   *
   * @return $this
   */
