 ...
 *
 * @category Class
 * @description bandwidth-saving JSON-Object for a list of contacts. Contains schema information that can be used to
 *   interpret the summary and phoneNumber values of a contact and the ContactSummary-Objects.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactList implements ModelInterface, ArrayAccess
{
   ...
   * Sets metadata
   *
   * @param RequestMetadata $metadata metadata
   *
   * @return $this
   */
   ...
   *
   * @param Block $summary_block_schema summary_block_schema
   *
   * @return $this
   */
   ...
   *
   * @param Block $phone_numbers_block_schema phone_numbers_block_schema
   *
   * @return $this
   */
   ...
   * Sets contacts
   *
   * @param ContactSummary[] $contacts List of ContactSummary
   *
   * @return $this
   */
