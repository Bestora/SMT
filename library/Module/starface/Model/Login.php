 ...
 *
 * @category Class
 * @description A JSON-Object used for the authentification process. The Server can be asked for a Template-Login-Object holding a valid nonce and the loginType but no secret. The Template-Login-Object can then be used to login by filling in the secret of a user.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Login implements ModelInterface, ArrayAccess
{
     ...
     * Sets login_type
     *
     * @param string $login_type The loginType that is configured at the server. Determines the function used to obtain the user's secret.
     *
     * @return $this
     */
     ...
     * Sets nonce
     *
     * @param string $nonce A string provided by the server that can be used to login only once. Only server generated nonces are valid.
     *
     * @return $this
     */
