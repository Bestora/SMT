...
('allowed_auto_system_ip', 'on', 'text', 'nein'),
('allowed_auto_system_port', 'on', 'text', 'nein'),
...
('controller', 'server,administration,inventory,knowledge,ticket,monitor,vmware', 'text', 'nein'),
('fast_port_scanner', '65535', 'text', 'nein'),
...
('ldap_dn', 'OU=DF-Mitarbeiter,DC=domain,DC=de', 'text', 'nein'),
('ldap_host', '', 'text', 'nein'),
('ldap_manager_group', 'IT & Development', 'text', 'nein'),
('ldap_pass', '', 'password', 'nein'),
('ldap_user', 'Administrator', 'text', 'nein'),
('ldap_user_auth_field', 'mail', 'text', 'ja'),
('ldap_user_group', 'Mitarbeiter', 'text', 'nein'),
('ldap_usr_dom', '@domain.de', 'text', 'nein'),
('messagebird_api_token', '', 'text', 'nein'),
('messsagebird_flowtoken', '', 'text', 'nein'),
('monitor_email_address', 'monitor@email.de', 'text', 'nein'),
('only_admin_methode', 'license,admin,hardware', 'text', 'nein'),
('pushover_api_token', '', 'text', 'nein'),
('starface_login_id', '', 'text', 'nein'),
('starface_login_pw', '++', 'password', 'nein'),
...
(434, 'standby_report', 'Berichte schreiben', 'sys'),
...
(441, 'monthly_report', 'Monatsbericht', 'sys'),
(442, 'choose_year', 'Jahr wählen', 'sys'),
(443, 'show_report', 'Berichte anzeigen', 'sys'),
(444, 'reports_for_week', 'Berichte für Woche', 'sys'),
(445, 'choose_day', 'Tag wählen', 'sys'),
(446, 'admin_text_close', 'Schließen', 'sys'),
(447, 'monthly_report_send', 'Monatsbericht senden', 'sys'),
(448, 'monthly_report_choose', 'Monat wählen', 'sys'),
(449, 'recipient', 'Empfänger', 'sys'),
(450, 'monthly_report_enter_emails', 'Bitte Email Adressen eingeben..', 'sys'),
(451, 'monthly_report_accept_enter', 'Email Adresse mit Enter bestätigen!', 'sys'),
(452, 'monthly_report_sent_to_you', 'Die Email wird sowohl an die Empfänger in dieser Liste als auch an dich selbst gesendet!', 'sys'),
(453, 'admin_text_send', 'Senden', 'sys'),
(454, 'standby_add_user', 'Mitarbeiter zu Rufbereitschaft hinzufügen', 'sys'),
(455, 'choose_please', 'Bitte Wählen..', 'sys'),
(456, 'admin_text_days', 'Tage', 'sys'),
(457, 'admin_text_all', 'Alle', 'sys'),
